...
class BarraNavegacion extends Component {
  ...
  render() {
    return <>{this.navegacionYContenido()}</>;
  }
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
              <div className="container-fluid">
                <button
                  ...
                  onClick={() => this.efectobarraLateral()}
                >
                  <i className="fa">
                ...
                <button
                  className=".color-dark btn-dark d-inline-block d-lg-none ml-auto btn"
                  data-toggle="collapse"
